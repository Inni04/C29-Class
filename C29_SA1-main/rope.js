class Rope
  ...
  this.pointA = pointA;
  this.body = Composites.chain(rects, 0.1, 0, -0.6, 0, {stiffness: 0.1, length: 0.1, render: {type: 'line'}}); //render means displaying
  ...
  World.add(engine.world, this.body);
    ...
    show()
    {
      if(this.body!=null)
        {
          for (let i = 0; i < this.body.bodies.length-1; i++) //let is like var
          {
